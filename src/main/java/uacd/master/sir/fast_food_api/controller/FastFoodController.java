...
public class FastFoodController {
    ...
    ResponseEntity<FastFoodResponseDTO> saveFastFoodWithIdUtilisateur(@RequestBody FastFoodRequestDTO dto, @PathVariable int idUtilisateur) {
        FastFoodResponseDTO fastFoodResponseDTO = fastFoodService.saveFastFoodWithIdUtilisateur(dto, idUtilisateur);
        return new ResponseEntity<>(fastFoodResponseDTO, HttpStatus.CREATED);
    }
